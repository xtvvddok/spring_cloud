		...
		<div class="row clearfix">
			<div class="span6">
				<div class="clearfix">
					...
					<hr>
					<div id="build" >
						<input type="hidden" id="n_id" name="n_id" value='${activity.id }' />
						<form id="target" class="form-horizontal" >
							
							<legend class="valtype" data-valtype="text" style="text-align: center">${activity.title }</legend>
...
function save(){
	...
	if(checkNull()){
		$.ajax({
		   type: "POST",
		   url:"${root}/manage/saveActivityContent",
