...
//	private Map<String,String> order = new HashMap<>();
	...
	private void reflectObject(T obj) throws Exception {
		...
		if (obj.getClass().isAnnotationPresent(Table.class)) {
			...
			sql_condition.append(classname);
...
//			obj.getClass().getm
			...
			if (value != null) {
				...
				sql_condition.append("o.").append(name);
...
//				System.out.println(m.getName()+"--"+"get"+name);
				return m;
			}
		}
...
//	}
	...
	private List<T> find(String hql, List<Object> objects) {
		Query query = WebApplicationContextUtil.getSession().createQuery(hql);
